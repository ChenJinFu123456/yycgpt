...
<script type="text/javascript">
	var addyycgdmx = function() {
		_confirm('您确定要执行添加选中的药品吗?', null, function() {
...
<BODY>
	<div id="ypxxquery_div">
		<form id="gysypmlForm" name="gysypmlForm"
			action="${baseurl}cgd/addyycgdmxsubmit.action" method="post">
			<input type="hidden" name="yycgdid" value="${yycgdid}"> <input
				type="hidden" name="indexs" id="indexs" />
			<TABLE class="table_search">
				<TBODY>
					...
					<tr>
						...
						<td><select id="ypxxCustom.zlcc" name="ypxxCustom.zlcc"
							style="width: 150px">
								<option value="">全部</option>
