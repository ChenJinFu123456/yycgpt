...
<script type="text/javascript">
	var gysypmldel = function() {
		_confirm('您确定要执行删除选中的产品吗?', null, function() {
	...
	var gysypmladd = function() {
		...
		createmodalwindow("供货产品添加", 1000, 500, sendUrl);
	...
	function initGrid() {
		$('#gysypmllist').datagrid({
			...
			onClickRow : function(index, field, value) {//点击行的时候触发的事件
...
<BODY>
	<div id="ypxxquery_div">
		<form id="gysypmldeleteForm" name="gysypmldeleteForm"
			action="${baseurl}ypml/deletegysypmlsubmit.action" method="post">
