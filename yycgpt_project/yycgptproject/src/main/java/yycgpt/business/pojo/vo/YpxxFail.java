...
public class YpxxFail {
	...
	public String getPzwhyxq() {
		return pzwhyxq;
	}

	public void setPzwhyxq(String pzwhyxq) {
	...
	public String getYpjybgyxq() {
		return ypjybgyxq;
	}

	public void setYpjybgyxq(String ypjybgyxq) {
